...
-(void)showTradeList{
    ...
    array = [self.nsjson objectForKey:@"result"];
    searchresult = [[NSArray alloc] initWithArray:array copyItems:YES];
}
...
- (void)filterContentForSearchText:(NSString*)searchText scope:(NSString*)scope
{
    ...
    searchresult = [array filteredArrayUsingPredicate:resultPredicate];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *tempDictionary= [searchresult objectAtIndex:indexPath.row];
